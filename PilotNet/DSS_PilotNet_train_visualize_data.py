#DSS_PilotNet_train_visualize_data.py
import os
import cv2
import numpy as np
...
def play_driving_video_auto(data_dir, fps=15):
    ...
    print("🚗 Loading DSS PilotNet driving data...")
    ...
    def update_frame(frame_idx):
        ...
        info_text = f"DSS Steering angle: {angle_degrees:.6f} degrees\nScenario image size: {img_width} x {img_height}"
        ...
        fig.suptitle(f'DSS PilotNet Driving Video - Progress: {progress:.1f}% ({frame_idx+1}/{len(images)})', 
...
if __name__ == "__main__":
    ...
    print("🎬 DSS PilotNet Driving Data Auto Player")
    print("=" * 50)
